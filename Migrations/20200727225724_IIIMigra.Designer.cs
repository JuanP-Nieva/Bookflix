...
namespace Bookflix.Migrations
{
    ...
    [Migration("20200727225724_IIIMigra")]
    partial class IIIMigra
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookflix.Models.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bookflix.Models.Usuario_Recibe_Notificacion", b =>
                {
                    b.Property<string>("BookflixUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("NotificacionId")
                        .HasColumnType("int");

                    b.HasKey("BookflixUserId", "NotificacionId");

                    b.HasIndex("NotificacionId");

                    b.ToTable("Usuario_Recibe_Notificaciones");
                });
            ...
            modelBuilder.Entity("Bookflix.Models.Usuario_Recibe_Notificacion", b =>
                {
                    b.HasOne("Bookflix.Models.BookflixUser", "BookflixUser")
                        .WithMany("Usuario_Recibe_Notificaciones")
                        .HasForeignKey("BookflixUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Bookflix.Models.Notificacion", "Notificacion")
                        .WithMany("Usuario_Recibe_Notificaciones")
