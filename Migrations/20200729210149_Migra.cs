        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CantidadComentarios = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "Usuario_Recibe_Notificaciones",
                columns: table => new
                {
                    BookflixUserId = table.Column<string>(nullable: false),
                    NotificacionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usuario_Recibe_Notificaciones", x => new { x.BookflixUserId, x.NotificacionId });
                    table.ForeignKey(
                        name: "FK_Usuario_Recibe_Notificaciones_AspNetUsers_BookflixUserId",
                        column: x => x.BookflixUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Usuario_Recibe_Notificaciones_Notificaciones_NotificacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarcaSpoiler = table.Column<string>(nullable: true),
                    PerfilId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Perfil_Comenta_Libros", x => new { x.LibroId, x.NumeroComentario });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Perfil_Valora_Libros", x => new { x.PerfilId, x.LibroId });
                    table.ForeignKey(
                        name: "FK_Perfil_Valora_Libros_Libros_LibroId",
                        column: x => x.LibroId,
                        principalTable: "Libros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Perfil_Valora_Libros_Perfiles_PerfilId",
                        column: x => x.PerfilId,
                        principalTable: "Perfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Perfil_Lee_Capitulos", x => new { x.PerfilId, x.CapituloId });
                    table.ForeignKey(
                        name: "FK_Perfil_Lee_Capitulos_Capitulos_CapituloId",
                        column: x => x.CapituloId,
                        principalTable: "Capitulos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Perfil_Lee_Capitulos_Perfiles_PerfilId",
                        column: x => x.PerfilId,
                        principalTable: "Perfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Perfil_Lee_Capitulos_CapituloId",
                table: "Perfil_Lee_Capitulos",
                column: "CapituloId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Perfil_Valora_Libros_LibroId",
                table: "Perfil_Valora_Libros",
                column: "LibroId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuario_Recibe_Notificaciones_NotificacionId",
                table: "Usuario_Recibe_Notificaciones",
